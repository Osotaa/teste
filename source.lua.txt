...
--local Window = RayfieldLibrary:CreateWindow({
	...
	Main.Shadow.Image.ImageTransparency = 0
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "Shift Hub"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "Shift hub"

	if Settings.LoadingTitle ~= "Shift Hub" then
		LoadingFrame.Version.Text = "Shift Hub"
	end
...
if useStudio then
	...
	--local Window = RayfieldLibrary:CreateWindow({
	--	Name = "Shift Hub",
	--	LoadingTitle = "Carregando Shift Hub by Sota",
	--	Theme = 'Default',
	--	Icon = 0,
	--	LoadingSubtitle = "by Shift Hub",
	--	ConfigurationSaving = {
